...
Pattern.prototype._scope = Pattern.prototype.tscope;
Pattern.prototype._tscope = Pattern.prototype.tscope;
Pattern.prototype._fscope = Pattern.prototype.fscope;

export function scope(pat, config) {
  return pat.scope(config);
}

export function tscope(pat, config) {
  return pat.tscope(config);
}

export function fscope(pat, config) {
  return pat.fscope(config);
}
