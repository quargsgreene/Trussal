// Vendored verbatim from strudel-fork/packages/mondo/mondo.mjs (npm name
// "mondolang"). Copied into src/ so both the esbuild browser bundle and the
// bots process — which runs node against src/audio-net/ with no esbuild
// aliases — resolve the one self-contained Mondo parser/runner. It has no
// dependencies of its own. Refresh with:
//   cp strudel-fork/packages/mondo/mondo.mjs src/audio-net/mondo.mjs
