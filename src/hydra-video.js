...
let _stream    = null;   // MediaStream we opened (if FG stream not shared)
let _running   = false;
let _rafId     = null;
let _panelOpen = false;  // tracks whether the HV panel is visible
...
// ---------------------------------------------------------------------------
// Public: inject toggle button into the studio header
// ---------------------------------------------------------------------------
